...
public class TikTokDownloaderActivivty extends AppCompatActivity {

    EditText inputURl;
    Button BtnDownload;
    Button BtnPaste;
    public static boolean tiktokRunning = false;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tik_tok_downloader_activivty);
